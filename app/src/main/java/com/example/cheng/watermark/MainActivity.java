...
//    mWartermarkImage = (ImageView) findViewById(R.id.wartermark_pic);
    ...
    Bitmap sourBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.water_bg);
//    mSourImage.setImageBitmap(sourBitmap);
    ...
    BitmapUtils.saveImg(this, textBitmap, nameLetter, nameLetter);
//    File file = new File(getExternalFilesDir(Environment.DIRECTORY_PICTURES), sdf.format(new Date()) + ".jpg");
